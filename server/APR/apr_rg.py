import server.APR.ruleitem as ruleitem
...
def rule_generator(dataset, minimum_support, minimum_confidence):
    ...
    while frequent_rule_items.get_size() > 0 and present_classification_association_rules_no <= 2000 and (
            present_classification_association_rules_no - end_classification_association_rules_no) >= 10:
