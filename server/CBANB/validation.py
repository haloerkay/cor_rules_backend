...
def cross_validate_m1_without_prune(data_path, minsup=0.01, minconf=0.5):
    data, attributes, value_type = read(data_path)
    random.shuffle(data)
...
# 10-fold cross-validations on CBA (M1) with pruning
def cross_validate_m1_with_prune(data_path, minsup=0.01, minconf=0.5):
    data, attributes, value_type = read(data_path)
    random.shuffle(data)
    dataset = pre_process(data, attributes, value_type)
...
# 10-fold cross-validations on CBA (M2) without pruning
def cross_validate_m2_without_prune(data_path, minsup=0.01, minconf=0.5):
    data, attributes, value_type = read(data_path)
    random.shuffle(data)
    dataset = pre_process(data, attributes, value_type)
...
# 10-fold cross-validations on CBA (M2) with pruning
def cross_validate_m2_with_prune(data_path,  minsup=0.01, minconf=0.5):
    data, attributes, value_type = read(data_path)
    random.shuffle(data)
    dataset = pre_process(data, attributes, value_type)
